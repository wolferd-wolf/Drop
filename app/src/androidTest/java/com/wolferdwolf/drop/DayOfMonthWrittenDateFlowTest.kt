...
class DayOfMonthWrittenDateFlowTest {
    @Test
    fun dayOfMonthWrittenDateReachesEditableExtractionAndSuggestedActions() {
        ActivityScenario.launch(MainActivity::class.java).use {
            ...
            assertVisibleAfterScroll(device, "15th of August 2026", "Day-of-month written date must be visible and editable")
