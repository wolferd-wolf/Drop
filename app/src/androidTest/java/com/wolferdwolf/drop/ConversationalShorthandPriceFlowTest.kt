...
class ConversationalShorthandPriceFlowTest {
    @Test
    fun shorthandPriceRemainsEditableAndReachesSuggestedActions() {
        ActivityScenario.launch(MainActivity::class.java).use {
            ...
            input.text = "Wolf shelter supply budget: 1.5 lakh rupees."
            ...
            assertVisibleAfterScroll(device, "1.5 lakh rupees", "Conversational shorthand price must be visible and editable")
            capture(device, "/data/local/tmp/drop-conversational-shorthand-price-extraction.png")
            ...
            capture(device, "/data/local/tmp/drop-conversational-shorthand-price-actions.png")
        }
    }
