...
class MonthFirstNumericDateFlowTest {
    @Test
    fun monthFirstDateReachesEditableExtractionAndSuggestedActions() {
        ActivityScenario.launch(MainActivity::class.java).use {
            ...
            input.text = "Conference starts 08/15/2026 at 9:30 AM."
            ...
            assertVisibleAfterScroll(device, "08/15/2026", "Month-first date must be visible and editable")
            capture(device, "/data/local/tmp/drop-month-first-date-extraction.png")
            ...
            capture(device, "/data/local/tmp/drop-month-first-date-actions.png")
        }
    }
