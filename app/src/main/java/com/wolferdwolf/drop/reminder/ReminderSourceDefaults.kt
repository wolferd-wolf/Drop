...
/**
 * Conservative defaults derived from extracted source text.
 * Only concrete ISO dates and clock times are carried into the editable form;
 * ambiguous or deadline-only language keeps the safe fallback values.
 */
