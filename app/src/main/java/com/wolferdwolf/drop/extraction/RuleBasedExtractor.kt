...
object RuleBasedExtractor {
    ...
    private val rules = listOf(
        ...
        Rule(ExtractionType.URL, Regex("(?i)\\b(?:(?:https?://|www\\.)[^\\s<>()]+|(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\\.)+(?:com|org|net|in|io|app|co|dev|ai|me|tech|store|online|site|xyz|cloud|live|news|shop|info|biz|edu|gov)(?:/[^\\s<>()]*)?)"), 0.96f),
        ...
        Rule(ExtractionType.DATE, Regex("(?i)\\b(?:jan(?:uary)?|feb(?:ruary)?|mar(?:ch)?|apr(?:il)?|may|jun(?:e)?|jul(?:y)?|aug(?:ust)?|sep(?:tember)?|oct(?:ober)?|nov(?:ember)?|dec(?:ember)?)\\s+(?:0?[1-9]|[12]\\d|3[01])(?:st|nd|rd|th)?(?:,?\\s+'?\\d{2,4})?\\b"), 0.93f),
